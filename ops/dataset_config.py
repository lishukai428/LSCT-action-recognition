...
ROOT_DATASET = '/media/workstation/1/lishukai/'  # '/data/jilin/'
...
def return_something(modality):
    ...
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'sthv1/something-something-v1-frames'
...
def return_somethingv2(modality):
    filename_categories = 'sthv2/label/category.txt'
    if modality == 'RGB':
        root_data = ROOT_DATASET + 'sthv2/20bn-something-something-v2-frames'
        filename_imglist_train = 'sthv2/train_videofolder.txt'
        filename_imglist_val = 'sthv2/val_videofolder.txt'
        prefix = '{:06d}.jpg'
    elif modality == 'Flow':
