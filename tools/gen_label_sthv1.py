...
if __name__ == '__main__':
    dataset_name = '/media/workstation/1/lishukai/sthv1/something-something-v1'  # 'jester-v1'
    ...
    files_input = ['%s-test.csv' % dataset_name]
    # files_output = ['val_videofolder.txt', 'train_videofolder.txt']
    files_output = ['test_videofolder1.txt']
    for (filename_input, filename_output) in zip(files_input, files_output):
        ...
        for i in range(len(folders)):
            ...
            dir_files = os.listdir(os.path.join('/media/workstation/1/lishukai/sthv1/something-something-v1-frames', curFolder))
            output.append('%s %d %d' % ('/media/workstation/1/lishukai/sthv1/something-something-v1-frames/' + curFolder, len(dir_files), curIDX))
